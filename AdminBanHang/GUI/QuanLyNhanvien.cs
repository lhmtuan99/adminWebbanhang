...
namespace AdminBanHang.GUI
{
    public partial class QuanLyNhanvien : Form
    {
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Exists Username ", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }    
        ...
        private void ClickRow(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex > -1 && e.RowIndex < count )
            {
                ...
                dob.Value = (DateTime)row.Cells[8].Value;
                txtAddress.Text = row.Cells[7].Value.ToString();
                joindate.Value = (DateTime)row.Cells[9].Value;
