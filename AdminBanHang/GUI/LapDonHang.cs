...
namespace AdminBanHang.GUI
{
    public partial class LapDonHang : Form
    {
        ...
        {
            ProductBLL productBLL = new ProductBLL();
            comboBoxBrand.DataSource = productBLL.GetAllCompany();
        ...
        private void comboBoxType_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            comboBoxBrand.DataSource = productBLL.GetTypes(types.Id);
            comboBoxBrand.DisplayMember = "TypeName";
        }
        ...
        private void LoadImageSelect(ArrayList arr_product, ArrayList arr_combo)
        {
            ...
            {
                string folder = @"C:\Users\Admin\Documents\GitHub\adminBanHang\AdminBanHang\Resources\";
        ...
        private void loadkhaibaoviewselct()
        {
            ...
            listViewSelect.Columns.Add("Image", 80);
            listViewSelect.Columns.Add("Product name", 100);
            listViewSelect.Columns.Add("Amount", 30);
            listViewSelect.Columns.Add("Price", 70);
            listViewSelect.Columns.Add("Total", 70);
        }
        ...
        private void radioCombo_CheckedChanged(object sender, EventArgs e)
        {

        }
        public void addForm(Panel f)
        {
            this.panelSearch.Controls.Clear();
            f.AutoScroll = true;
            f.Dock = DockStyle.Fill;
            this.Text = f.Text;
            this.panelSearch.Controls.Add(f);
            f.Show();
        }
        private void radioProduct_CheckedChanged(object sender, EventArgs e)
        {
            if(this.radioProduct.Checked)
            {
                LoadListViewProduct();
                addForm(panelProduct);
                groupBoxProduct.Text = "Product search";
                btnMove.Enabled = false;
                check = false;
            }
            else
            {
                LoadListViewCombo();
                addForm(panelCombo);
                groupBoxProduct.Text = "Combo search";
                btnMove.Enabled = false;
                check = true;
            }
        ...
        private void btnSearchCombo_Click_1(object sender, EventArgs e)
        {
            clickSearch = true;
            LoadListViewCombo();
            clickSearch = false;
        ...
        {
            ProductBLL productBLL = new ProductBLL();
            Company company = (Company)comboBoxBrand.SelectedItem;
            //comboBoxType.DataSource = productBLL.GetTypes(types.Id);
            //comboBoxBrand.DisplayMember = "TypeName";
        }

        private void btnResetCombo_Click_1(object sender, EventArgs e)
        {
            LoadListViewCombo();
        }

        private void btnResetProduct_Click_1(object sender, EventArgs e)
        {
            LoadListViewProduct();
        }
