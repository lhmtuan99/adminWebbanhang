...
namespace AdminBanHang.GUI
{
    public partial class QuanlyHoadon : Form
    {
        ...
        private void LoadListViewInvoice()
        {
            ...
            listViewInvoice.Columns.Add("Customer name", 100);
            listViewInvoice.Columns.Add("Amount", 20);
            listViewInvoice.Columns.Add("Total", 70);
            listViewInvoice.Columns.Add("Date Create", 70);
            listViewInvoice.Columns.Add("Postcode", 60);
            listViewInvoice.Columns.Add("Status", 60);
            listViewInvoice.Columns.Add("Detail", 200);
            listViewInvoice.Columns.Add("Address", 200);
